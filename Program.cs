    ...
    internal class Program : AboutNum
    {
       ...
       public static float c = str += 9;
        ...
        private static void WeaponSelect()
        {
            ...
            Task.Delay(100).Wait();
            Console.WriteLine("1. 킬소드: 명중률은 낮지만 필살 일격의 재격");
       ...
       public static void Game()
        {
            ...
            Console.WriteLine("     /적\\");
            Console.WriteLine($"   체력:{EnemyHealth.hp}/{EnemyHealth.maxhp}");
            Console.WriteLine($"    명중률: {eH}%");
            Console.WriteLine($"    필살률: {eC}%");
            Console.WriteLine($"    공격력: {eS}\n");
